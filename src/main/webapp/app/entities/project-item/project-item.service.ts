...
export class ProjectItemService {
    ...
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/project-items';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IProjectItem[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
