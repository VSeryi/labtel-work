...
export class ProjectPermissionService {
    ...
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/project-permissions';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IProjectPermission[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
