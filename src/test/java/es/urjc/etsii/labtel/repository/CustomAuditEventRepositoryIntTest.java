...
import es.urjc.etsii.labtel.config.audit.AuditEventConverter;
import es.urjc.etsii.labtel.domain.PersistentAuditEvent;
...
import static es.urjc.etsii.labtel.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
