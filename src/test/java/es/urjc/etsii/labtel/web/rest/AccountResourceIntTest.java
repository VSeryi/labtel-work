...
import es.urjc.etsii.labtel.config.Constants;
import es.urjc.etsii.labtel.domain.Authority;
import es.urjc.etsii.labtel.domain.User;
import es.urjc.etsii.labtel.repository.AuthorityRepository;
import es.urjc.etsii.labtel.repository.UserRepository;
import es.urjc.etsii.labtel.security.AuthoritiesConstants;
import es.urjc.etsii.labtel.service.MailService;
import es.urjc.etsii.labtel.service.UserService;
import es.urjc.etsii.labtel.service.dto.PasswordChangeDTO;
import es.urjc.etsii.labtel.service.dto.UserDTO;
import es.urjc.etsii.labtel.web.rest.errors.ExceptionTranslator;
import es.urjc.etsii.labtel.web.rest.vm.KeyAndPasswordVM;
import es.urjc.etsii.labtel.web.rest.vm.ManagedUserVM;
