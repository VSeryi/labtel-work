...
import es.urjc.etsii.labtel.repository.search.ProjectSearchRepository;
...
public class ProjectResourceIntTest {
     ...
     *
     * @see es.urjc.etsii.labtel.repository.search.ProjectSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getValue()).isEqualTo(DEFAULT_VALUE);
    ...
    public void updateProject() throws Exception {
        ...
        Project testProject = projectList.get(projectList.size() - 1);
        assertThat(testProject.getValue()).isEqualTo(UPDATED_VALUE);
