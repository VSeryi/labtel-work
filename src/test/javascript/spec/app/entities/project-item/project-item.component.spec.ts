...
import { ProjectItemComponent } from 'app/entities/project-item/project-item.component';
...
describe('Component Tests', () => {
    describe('ProjectItem Management Component', () => {
        let comp: ProjectItemComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.projectItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
