...
import { ProjectPermissionComponent } from 'app/entities/project-permission/project-permission.component';
...
describe('Component Tests', () => {
    describe('ProjectPermission Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.projectPermissions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
